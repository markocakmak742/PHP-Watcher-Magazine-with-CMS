...
protected static $db_table_fields = array('id', 'title', 'Introductory_text', 'main_text', 'image', 'paragraph', 'type', 'size', 'category', 'priority','date');
...
return static::find_by_query("SELECT * FROM posts WHERE category = '" . $category . "'" . "order by length(priority), priority");  
...
if($this->image_placeholder != "images/default.jpg") {    
