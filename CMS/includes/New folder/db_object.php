...
$target_path = $_SERVER['DOCUMENT_ROOT'] . "/gallery/admin/" . "/" . $this->upload_directory . "/" . $this->image;
...
$the_resault_array = static::find_by_query("SELECT * FROM " . static::$db_table . " WHERE id= $id LIMIT 1");
...
$the_object_user = new $calling_class;


foreach ($the_record as $the_attribute => $value) {

if($the_object_user->has_the_attribute($the_attribute)) {

$the_object_user->$the_attribute = $value;


}
}

return $the_object_user;
